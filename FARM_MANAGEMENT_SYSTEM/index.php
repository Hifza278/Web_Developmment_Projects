...
<html lang="en">
	...
	<script>
		...
		$(document).ready(function(){
					$(".square").animate({'margin-left': '60%'}, 10000).animate({'margin-left':'-60%'},14000).animate({'margin-left':'0'},10000);
	...
	?>
		...
		<!-- Banner -->
			<section id="banner" class="wrapper">
				<div class="container">
				<h2>AgroCulture</h2>
				<p class = "square"  >Your Product Our Market </p>
				<br><br>
				<center>
		...
		<div class="footer-center">
			...
			<div>
				...
				<p style="font-size:20px"><a href="mailto:aamirk2244@gmail.com" style="color:white">example@gmail.com</a></p>
			</div>
		</div>
